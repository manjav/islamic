package com.gerantech.islamic.models
{
	...
	public class ResourceModel
	{
		...
		{
			quranXML = XML(new quranClass());//AppModel.instance.assetManager.getXml("quran-uthmani");
			metaXML =  XML(new metaClass());//AppModel.instance.assetManager.getXml("uthmani-metadata");
